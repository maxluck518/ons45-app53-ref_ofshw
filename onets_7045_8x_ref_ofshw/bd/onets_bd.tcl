...
[get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_1/s_axi_lite_clk] [get_bd_pins axi_ethernet_4/s_axi_lite_clk] [get_bd_pins axi_ethernet_5/s_axi_lite_clk] \
[get_bd_pins axi_dma_0/s_axi_lite_aclk]

connect_bd_net  [get_bd_pins processing_system7_0/FCLK_CLK1] \
[get_bd_pins packet_pipeline/s_axi_lite_aclk] [get_bd_pins packet_pipeline/clk_control] [get_bd_pins packet_pipeline/clk_lookup]

connect_bd_net  [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] \
[get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins axi_ethernet_4/axis_clk] [get_bd_pins axi_ethernet_5/axis_clk] \
...
[get_bd_pins packet_pipeline/clk_line] [get_bd_pins packet_pipeline/s_axis_rxd_aclk] [get_bd_pins packet_pipeline/s_axis_txd_aclk]
...
connect_bd_net  [get_bd_pins rst_ps7_0_75M/peripheral_aresetn] \
[get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins axi_ethernet_4/s_axi_lite_resetn] [get_bd_pins axi_ethernet_5/s_axi_lite_resetn] \
...
connect_bd_net  [get_bd_pins rst_ps7_0_125M/peripheral_reset] \
[get_bd_pins packet_pipeline/clk_line_rst]

connect_bd_net  [get_bd_pins rst_ps7_0_75M/peripheral_reset] \
[get_bd_pins packet_pipeline/clk_lookup_rst] [get_bd_pins packet_pipeline/clk_control_rst]
...
# 1000baseX
connect_bd_net [ get_bd_pins axi_ethernet_4/mmcm_locked_out]       [ get_bd_pins axi_ethernet_5/mmcm_locked]
connect_bd_net [ get_bd_pins axi_ethernet_4/rxuserclk_out]         [ get_bd_pins axi_ethernet_5/rxuserclk]
connect_bd_net [ get_bd_pins axi_ethernet_4/rxuserclk2_out]        [ get_bd_pins axi_ethernet_5/rxuserclk2]
connect_bd_net [ get_bd_pins axi_ethernet_4/userclk_out]           [ get_bd_pins axi_ethernet_5/userclk]
connect_bd_net [ get_bd_pins axi_ethernet_4/userclk2_out]          [ get_bd_pins axi_ethernet_5/userclk2]
connect_bd_net [ get_bd_pins axi_ethernet_4/pma_reset_out]         [ get_bd_pins axi_ethernet_5/pma_reset]
connect_bd_net [ get_bd_pins axi_ethernet_4/gt0_qplloutclk_out]    [ get_bd_pins axi_ethernet_5/gt0_qplloutclk_in]
connect_bd_net [ get_bd_pins axi_ethernet_4/gt0_qplloutrefclk_out] [ get_bd_pins axi_ethernet_5/gt0_qplloutrefclk_in]
connect_bd_net [ get_bd_pins axi_ethernet_4/gtref_clk_out]         [ get_bd_pins axi_ethernet_5/gtref_clk]
connect_bd_net [ get_bd_pins axi_ethernet_4/gtref_clk_buf_out]     [ get_bd_pins axi_ethernet_5/gtref_clk_buf]

connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK2] \
[get_bd_pins axi_ethernet_4/ref_clk] [get_bd_pins axi_ethernet_5/ref_clk]
...
#
# temp
# connect_bd_intf_net [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axi_ethernet_0/m_axis_rxd]
# connect_bd_intf_net [get_bd_intf_pins axi_dma_0/S_AXIS_STS] [get_bd_intf_pins axi_ethernet_0/m_axis_rxs]
# connect_bd_intf_net [get_bd_intf_pins axi_ethernet_0/s_axis_txd] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
# connect_bd_intf_net [get_bd_intf_pins axi_ethernet_0/s_axis_txc] [get_bd_intf_pins axi_dma_0/M_AXIS_CNTRL]
